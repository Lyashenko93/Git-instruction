 ...
 *Git checkout <имя ветки>* - команда для переключения с одной ветки на другую ветку.
...
Для того чтобы слить любую ветку с текущей веткой, вызываем команду ***git merge <имя ветки для слияния с текущей>***
